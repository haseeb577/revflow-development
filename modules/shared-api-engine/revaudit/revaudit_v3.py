...
class RevAudit:
    def __init__(self):
        ...
        self.modules = [
            {'num': 1, 'name': 'revscore_iq', 'brand': 'RevScore IQ™', 'suite': 'Lead Gen > AI-SEO', 'purpose': 'Assessment & Scoring', 'backend': '/opt/revscore_iq', 'ui': 'get_revflow_client().get_service("data_provider")'},
            ...
            {'num': 17, 'name': 'revcore', 'brand': 'RevCore™', 'suite': 'Tech Efficiency', 'purpose': 'Unified Platform', 'backend': '/opt/shared-api-engine', 'ui': 'get_revflow_client().get_service("csv_import")'},
