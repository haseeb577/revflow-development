...
**Generated:** 2026-01-14 12:13:06 UTC  
...
|---------|--------|--------|
| revflow-lead-scoring.service | active | ActiveEnterTimestamp=Wed 2026-01-14 11:10:07 CST |
...
| revflow-flask.service | activating | ActiveEnterTimestamp=Wed 2026-01-14 11:12:58 CST |
...
| revaudit_modules | 120 kB |
| revaudit_ports | 80 kB |
...
```bash
scp root@217.15.168.106:/opt/shared-api-engine/revaudit/reports/REVFLOW_AUDIT_v4_20260114_121257.md ~/Downloads/
```
