...
**Generated:** 2026-01-14 12:38:08 UTC  
...
|---------|--------|--------|
| revflow-lead-scoring.service | active | ActiveEnterTimestamp=Wed 2026-01-14 11:35:06 CST |
...
| revflow-flask.service | activating | ActiveEnterTimestamp=Wed 2026-01-14 11:37:58 CST |
...
| revaudit_modules | 176 kB |
| revaudit_ports | 112 kB |
...
```bash
scp root@217.15.168.106:/opt/shared-api-engine/revaudit/reports/REVFLOW_AUDIT_v4_20260114_123759.md ~/Downloads/
```
