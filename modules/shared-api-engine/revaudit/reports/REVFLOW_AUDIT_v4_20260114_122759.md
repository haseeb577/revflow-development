...
**Generated:** 2026-01-14 12:28:07 UTC  
...
|---------|--------|--------|
| revflow-lead-scoring.service | active | ActiveEnterTimestamp=Wed 2026-01-14 11:25:06 CST |
...
| revflow-flask.service | active | ActiveEnterTimestamp=Wed 2026-01-14 11:28:07 CST |
...
| revaudit_modules | 152 kB |
| revaudit_ports | 96 kB |
...
```bash
scp root@217.15.168.106:/opt/shared-api-engine/revaudit/reports/REVFLOW_AUDIT_v4_20260114_122759.md ~/Downloads/
```
